...
class Subpages_Widget extends WP_Widget {
	...
	function Subpages_Widget() {
		/* Widget settings. */
		$widget_ops = array( 'classname' => 'widget_subpages', 'description' => esc_html__('Display subpages if present page only.', 'betterwork') );

		/* Widget control settings. */
		$control_ops = array( 'width' => 300, 'height' => 350, 'id_base' => 'subpages-widget' );

		/* Create the widget. */
		$this->WP_Widget( 'subpages-widget', esc_html__('Betterwork: Subpages', 'betterwork'), $widget_ops, $control_ops );
	}
...
<?php		    /* After widget (defined by themes). */
	...
	function form( $instance ) {
		...
		<p>
		    ...
		    <br />
		    <?php esc_html_e('Leave the Title field blank if you would like to display the parent page Title instead.', 'betterwork'); ?>
		</p>
