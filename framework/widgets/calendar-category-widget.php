<?php
/**
 * Widget Name: Calendar Category Widget
 ...
 * @since 0.1
 */
add_action( 'widgets_init', 'calendar_category_load_widgets' );

/**
 * Register our widget.
 * 'Calcat_Widget_Calendar' is the widget class used below.
 *
 * @since 0.1
 */
function calendar_category_load_widgets() {
...
class Calcat_Widget_Calendar extends WP_Widget {
	...
	function Calcat_Widget_Calendar() {
		...
		$this->WP_Widget( 'calendar_category', esc_html__('Betterwork:: Calendar Category', 'betterwork'), $widget_ops );
	}
...
?>
		...
		<?php wp_dropdown_categories( array( 'name' => $this->get_field_name( 'posts_cat' ), 'selected' => $instance['posts_cat'], 'orderby' => 'Name' , 'hierarchical' => 1, 'show_option_all' => __( 'All Categories' ), 'hide_empty' => '0' ) ); ?><small>Please select <strong>Events</strong> category</small></p>
<?php
	}
}
